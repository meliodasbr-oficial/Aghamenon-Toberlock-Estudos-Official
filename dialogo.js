...
function abrirDialog() {
  ...
  document.body.style.overflow = 'hidden'; // Impede o scroll do body quando a overlay está aberta
}

// Função para fechar a caixa de diálogo
function fecharDialog() {
  updatesDialog.style.display = 'none';
  document.body.style.overflow = 'auto'; // Permite o scroll do body quando a overlay está fechada
}
